...
export const AUDIO_MODELS: AudioModel[] = [
  ...
  },
  {
    ...
    tag: "TTS",
    description:
      "bf_emma — British female voice with a crisp, measured delivery.",
    size: "~330 MB",
    task: "tts",
    engine: "kokoro",
    hfModelId: "onnx-community/Kokoro-82M-v1.0-ONNX",
    ...
    color: "#c026d3",
    prompts: [
      "Shall we begin? There's quite a lot to get through.",
      "The truth of it is rather simpler than it first appears.",
      "Take your time. There's no need to rush through any of this.",
    ],
  },
  {
    id: "kokoro-isabella",
    name: "Kokoro Isabella",
    tag: "TTS",
    description:
      "bf_isabella — British female voice, smooth and composed with a warm edge.",
    size: "~330 MB",
    task: "tts",
    engine: "kokoro",
    hfModelId: "onnx-community/Kokoro-82M-v1.0-ONNX",
    ...
    prompts: [
      ...
      "We don't often pause long enough to notice what's actually happening around us.",
      "Something in the light had changed, and she couldn't quite say when.",
    ],
  },
];
